...
<div id="componentWrapper" class="slider-wrapper">
	<div class="thumbContainer">
		<div class="thumbInnerContainer">
			<c:forEach var="channel" items="${channels}">
				<div class='thumbHolder'>
					<a target="_top" href="/start-game2/${channel.video.id}"
					...
					<span class="totalMatches"> games played:
						${channel.video.timesPlayed}</span> <span class="highscore"> high score: <nf:format number="${channel.highscore}" />
					</span>
