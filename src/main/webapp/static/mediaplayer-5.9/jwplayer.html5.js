...
(function(d) {
    function l(l) {
        ...
        function p(b) {
            Y && !T && (I.paused ? I.currentTime === I.duration && 3 < I.duration || t.pause() : (!a.isFF() || !("play" === b.type && t.state === e.BUFFERING)) && t.setState(e.PLAYING))
        }
        ...
        function A(b, c) {
            ...
            S = 0;
            I.src !== J.file || m || g ?
                (m || t.setState(e.BUFFERING), P = N = !1, H = c ? c : -1, I.src = J.file, I.load()) : (0 === b && (S = -1, t.seek(b)), n(), I.play());
            K = I.currentTime;
            m && u();
        ...
        var t = this,
            x = {
                ...
                emptied: s,
                ended: function() {
                    Y && t.state !== e.IDLE && (h(W), ea = -1, va = !0, t.sendEvent(f.JWPLAYER_MEDIA_BEFORECOMPLETE), Y && (t.setState(e.IDLE), va = !1, t.sendEvent(f.JWPLAYER_MEDIA_COMPLETE)))
                },
                error: function() {
...
(function(d) {
    function l(g) {
        ...
        function u(a) {
            ...
            switch (T) {
                case b.ENDED:
                    G.state !== e.IDLE && (W = !0, G.sendEvent(f.JWPLAYER_MEDIA_BEFORECOMPLETE), G.setState(e.IDLE), W = !1, G.sendEvent(f.JWPLAYER_MEDIA_COMPLETE));
                    break;
                case b.PLAYING:
        ...
        this.mute = function(b) {
            x && x.getVolume && (a.exists(b) || (b = !x.isMuted()), b ? (D = x.getVolume(), x.mute()) : (this.volume(D), x.unMute()))
        };
        this.detachMedia = function() {
        ...
        this.supportsFullscreen = function() {
            return !(!J || !J.requestFullscreen && !J.requestFullScreen && !J.webkitRequestFullscreen && !J.webkitRequestFullScreen && !J.webkitEnterFullscreen && !J.webkitEnterFullScreen && !J.mozRequestFullScreen && !J.msRequestFullscreen)
        };
        this.remove = function() {
            A();
            M && (J && J ===
...
(function(d) {
    ...
    d.html5.adskipbutton = function(h, j, b, d) {
        ...
        function s(a) {
            ...
            a === d && (g -= w.width, b.drawImage(w, y.width - (y.width - b.measureText(d).width) / 2 - 4, (e - w.height) / 2));
            b.fillText(a, g, c + 4)
        }
        ...
        L.updateSkipTime = function(b, c) {
            ...
            }), 0 < E - b ? (g(b), u && (u = !1, n.style.cursor = "default")) : u || (u || (u = !0, n.style.cursor = "pointer"), F ? v() : s()))
        };
...
(function(d) {
    ...
    l.captions = function(h, g) {
        ...
        function E(a) {
            0 < a ? (G = a - 1, J = Math.floor(a), G >= t.length || (t[G].data ? F.populate(t[G].data) : x === t.length ? (l("file not loaded: " + t[G].file), 0 !== J && u(c.JWPLAYER_CAPTIONS_CHANGED, t, 0), J = 0) : M = a, n(!1))) : (J = 0, n(!1))
        }
        ...
        this.setCurrentCaptions = function(b) {
            0 <= b && (J !== b && b <= t.length) && (E(b), b = p(), a.saveCookie("captionLabel", b[J].label), u(c.JWPLAYER_CAPTIONS_CHANGED, b, J))
        };
    ...
    e.controlbar = function(p, k) {
        ...
        function A(a) {
            ...
            var b = a.duration === Number.POSITIVE_INFINITY,
                ...
                h.isSafari() && !q;
            b || c ? (X.setText(p.jwGetPlaylist()[p.jwGetPlaylistIndex()].title || "Live broadcast"), D(!1)) : (B.elapsed && (b = h.timeFormat(a.position), B.elapsed.innerHTML = b), B.duration && (b = h.timeFormat(a.duration), B.duration.innerHTML = b), 0 < a.duration ? Fa(a.position / a.duration) : Fa(0), sa = a.duration, ma || X.setText())
        }
        ...
        function t(a) {
            fa && (Ba = Math.floor(a.track), B.cc && (B.cc.querySelector("button").className = 2 === fa.length && 0 === Ba ? "off" : ""), pa && 0 <= Ba && pa.setActive(a.track))
        }
        ...
        function D(b) {
            R && B.alt && (b === a && (b = R.parentNode && 320 <= R.parentNode.clientWidth), b && !ma ? g.style(Wa, u) : g.style(Wa, y))
        }
        ...
        function Na(a) {
            if (Ca) {
                var c = B[Ca].querySelector(".jwrail"),
                    ...
                    c = a.x / c.width;
                100 < c && (c = 100);
                a.type === h.touchEvents.DRAG_END ? (p.jwSeekDrag(!1), B.timeRail.className = "jwrail", Aa(), fb.time(c), Xa()) : (Fa(c), a = (new Date).getTime(), 500 < a - lb && (lb = a, fb.time(c)));
        ...
        function pb(a) {
            return function(b) {
                b.button ||
                    (B[a + "Rail"].className = "jwrail", "time" === a ? p.jwGetState() !== m.IDLE && (p.jwSeekDrag(!0), La(a)) : La(a))
            }
        }
        ...
        function Da(a) {
            if (Ca && !a.button) {
                var b = B[Ca].querySelector(".jwrail"),
                    c = h.bounds(b),
                    b = Ca,
                    c = xa() ? B[b].vertical ? (100 * c.bottom - a.pageY) / (100 * c.height) : (a.pageX - 100 * c.left) / (100 * c.width) : B[b].vertical ? (c.bottom - a.pageY) / c.height : (a.pageX - c.left) / c.width;
                "mouseup" === a.type ? ("time" === b && p.jwSeekDrag(!1), B[b + "Rail"].className = "jwrail", Aa(), fb[b.replace("H", "")](c)) : ("time" === Ca ? Fa(c) : Ha(c), a = (new Date).getTime(),
        ...
        function ab(a) {
            ...
            if ((ja = h.bounds(Ya)) && 0 !== ja.width) {
                var b;
                xa() ? (a = a.pageX ? a.pageX - 100 * ja.left : a.x, b = 100 * ja.width) : (a = a.pageX ? a.pageX - ja.left : a.x, b = ja.width);
        ...
        function Za() {
            h.foreach(gb, function(a, b) {
                ...
                "%" === b.position.toString().slice(-1) ? c.left = b.position : 0 <
                    sa ? (c.left = (100 * b.position / sa).toFixed(2) + "%", c.display = null) : (c.left = 0, c.display = "none");
                g.style(b.element, c)
            })
        }
        ...
        function hb(c, e, f, g) {
            if (q) {
                ...
                (new h.touch(e)).addEventListener(h.touchEvents.TAP,
                    function() {
                        var e = f;
                        "cc" === g ? (2 === fa.length && (e = ra), Ja ? (clearTimeout(Ja), Ja = a, c.hide()) : (Ja = setTimeout(function() {
                            c.hide();
                            Ja = a
                        }, 4E3), e()), X.sendEvent(b.JWPLAYER_USER_ACTION)) : "hd" === g && (2 === ia.length && (e = I), na ? (clearTimeout(na), na = a, c.hide()) : (na = setTimeout(function() {
                            c.hide();
                            na = a
            ...
            if (Sa[a]) {
                ...
                if (b && 0 < b.elements.length)
                    for (var j = 0; j < b.elements.length; j++) {
                            ...
                            switch (d.type) {
                                case r:
                                    ...
                                    if (p.src) {
                                        var t = K();
                                        t.id = aa + "_" + d;
                                        "elapsed" === d || "duration" === d ? (t.className = "jwtext jw" + d + " jwhidden", Wa.push(t)) : t.className = "jwtext jw" + d;
                                ...
                                case C:
                                    if ("blank" !== d.name) {
                                        ...
                                        if (!U(d + "Button").src || q && ("mute" === d || 0 === d.indexOf("volume")) ||
                                            ...
                                            q ? "hd" !== d && "cc" !== d && (new h.touch(m)).addEventListener(h.touchEvents.TAP, S(d)) : m.addEventListener("click", S(d), !1);
                                            m.innerHTML = "\x26nbsp;";
                                            m.tabIndex = -1;
                                    ...
                                    if (q && 0 === v.indexOf("volume")) k = void 0;
                                        ...
                                        for (var A = 0; A < Y.length; A++) {
                                            ...
                                            if (D) {
                                                ...
                                                2 === A && (E = T);
                                                2 === A && !u ? (D = K(), D.className = "jwprogressOverflow", D.appendChild(T), B[M] = D, z.appendChild(D)) : (B[M] = T, z.appendChild(T))
                                            }
                                        }
                                        ...
                                        q ? (u = new h.touch(z), u.addEventListener(h.touchEvents.DRAG_START, Ma), u.addEventListener(h.touchEvents.DRAG,
                                            Na), u.addEventListener(h.touchEvents.DRAG_END, Na), u.addEventListener(h.touchEvents.TAP, ob)) : (E = ha, "volume" === E && !u && (E += "H"), z.addEventListener("mousedown", pb(E), !1));
                                        "time" === ha && !q && (z.addEventListener("mousemove", kb, !1), z.addEventListener("mouseout", Xa, !1));
                                        ha = B[ha + "Rail"] = z;
                                        z = U(L + p);
                                        L = U(L + p);
                                        ...
                                        B[v] = d;
                                        d.vertical = t;
                                        "time" === v ? (ka = new e.overlay(aa + "_timetooltip", V), Ta = new e.thumbs(aa + "_thumb"), Ua = l.createElement("div"), Ua.className = "jwoverlaytext", bb = l.createElement("div"), k = Ta.element(), bb.appendChild(k), bb.appendChild(Ua), ka.setContents(bb), Ya = ha, qb(0), k = ka.element(), ha.appendChild(k), B.timeSliderRail || g.style(B.time, y), B.timeSliderThumb && g.style(B.timeSliderThumb, {
                                                "margin-left": U("timeSliderThumb").width / -2
                                            }), k = U("timeSliderCue"), p = {
                                                "z-index": 1
                                            },
                                            k && k.src ? (N("timeSliderCue"), p["margin-left"] = k.width / -2) : p.display = "none", g(H(".jwtimeSliderCue"), p), $a(0), Fa(0), Fa(0), $a(0)) : 0 === v.indexOf("volume") && (v = d, m = "volume" + (t ? "" : "H"), w = t ? "vertical" : "horizontal", g(H(".jw" + m + ".jw" + w), {
                                            width: U(m + "Rail", t).width + (t ? 0 : U(m + "Cap" + p).width + U(m + "RailCap" + p).width + U(m + "RailCap" + k).width + U(m + "Cap" + k).width),
                                            height: t ? U(m + "Cap" + p).height + U(m + "Rail").height + U(m + "RailCap" + p).height + U(m + "RailCap" + k).height + U(m + "Cap" + k).height : ""
                                        }), v.className += " jw" + w);
                                        k = d
                                    }
                                    d = k;
                        ...
                        d && ("volume" === b.elements[j].name && d.vertical ? (qa = new e.overlay(aa + "_volumeOverlay", V), qa.setContents(d)) : f.appendChild(d))
                    }
            }
        }
        ...
        function ga() {
            !mb && 1 < p.jwGetPlaylist().length && (!l.querySelector("#" + p.id + " .jwplaylist") || p.jwGetFullscreen()) ? (g.style(B.next, u), g.style(B.prev, u)) : (g.style(B.next, y), g.style(B.prev, y))
        }
        ...
        function za(a, b) {
            if (B[a]) {
                var c = B[a].vertical,
                    ...
                    e = B[e + "Thumb"],
                    h;
                d && (h = {}, c ? (h.height = f, h.bottom = 0) : h.width = f, "volume" !== a && (h.opacity = 0 < b || Ca ? 1 : 0), g.style(d, h));
        ...
        var V, ba = w("divider", "divider"),
            ca = {
                ...
                layout: {
                    ...
                    right: {
                        position: "right",
                        elements: [w("duration", r), w("hd", C), w("cc", C), w("mute", C), w("volume", n), w("volumeH", n), w("cast", C), w("fullscreen", C)]
                    }
                }
            },
            $, Sa, B, Ia, R, aa, sa, ia = [],
            ...
            fb = {
                time: function(a) {
                    db ? (a = db.position, a = "%" === a.toString().slice(-1) ? sa * parseFloat(a.slice(0, -1)) / 100 : parseFloat(a)) : a *= sa;
                    p.jwSeek(a)
                },
                volume: function(a) {
                    Ha(a);
        ...
        X.redraw = function(a) {
            ...
            (b = Math.floor($.maxwidth)) && R.parentNode && h.isIE() && (!ta && R.parentNode.clientWidth > b + 2 * Math.floor($.margin) ? g.style(R, {
                width: b
            }) : g.style(R, {
                width: ""
            }));
        ...
        X.adMode = function(a) {
            if (j.isBoolean(a) && a !== mb) {
                ...
                } else b = Wa, c = B.elapsed, -1 === j.indexOf(b, c) && b.push(c), b = Wa, c = B.duration, -1 === j.indexOf(b, c) && b.push(c);
        ...
        B.mute && (B.volume && B.volume.vertical) && (qa = new e.overlay(aa + "_volumeoverlay", V), qa.setContents(B.volume), la(qa, B.mute, W), ib.volume = qa);
        g.style(Ea.right, {
            right: U("capRight").width
        });
        vb && R.appendChild(vb);
            ...
            if (!ma) {
                ...
                if (j.isArray(a) && !q)
                    for (var e = 0; e < a.length; e++)
                        if (!b &&
                            (a[e].file && a[e].kind && "thumbnails" === a[e].kind.toLowerCase()) && (Ta.load(a[e].file), b = !0), a[e].file && a[e].kind && "chapters" === a[e].kind.toLowerCase()) {
                            var f = a[e].file;
...
(function(d) {
    ...
    d.html5.controller = function(e, h) {
        ...
        function C() {
            e.state === c.IDLE && (z ? z = !1 : (p = C, e.repeat ? v() : e.item === e.playlist.length - 1 ? (E = 0, k(!0), setTimeout(function() {
...
(function(d) {
    ...
    l.display = function(d, g) {
        ...
        function q(a, b) {
            S.showicons && (a || b ? (K.setRotation("buffer" === a ? parseInt(S.bufferrotation, 10) : 0, parseInt(S.bufferinterval, 10)), K.setIcon(a),
                K.setText(b)) : K.hide())
        }

        function s(a) {
            A !== a ? (A && E(j, !1), (A = a) ? (a = new Image, a.addEventListener("load", r, !1), a.src = A) : (e("#" + u.id + " " + j, {
                "background-image": ""
        ...
        function C(a) {
            ...
            if (a !== P) switch (P = a, K && K.setRotation(0), a) {
                case f.IDLE:
                    !x && !M && (A && !G && E(j, !0), a = !0, d._model && !1 === d._model.config.displaytitle && (a = !1), q("play", w && a ? w.title : ""));
                    break;
                case f.BUFFERING:
                    x = !1;
        ...
        this.show = function(a) {
            if (K && (a || (N ? N : d ? d.jwGetState() : f.IDLE) !== f.PLAYING)) clearTimeout(H), H = void 0, u.style.display = "block", K.show(), J = !1
        };
        this.hide = function() {
            K && (K.hide(), J = !0)
        };
        ...
        z = {
            font: S.fontweight + " " + S.fontsize + "px/" + (parseInt(S.fontsize, 10) + 3) + "px Arial, Helvetica, sans-serif",
            color: S.fontcolor
        };
        K =
...
(function(d) {
    ...
    d.html5.displayicon = function(h, j, b, m) {
        ...
        function k(b, c, e, f) {
            ...
            d.src ? (e = l.extend({}, e), 0 < b.indexOf("Icon") && (G = d.width | 0), e.width = d.width, e["background-image"] = "url(" + d.src + ")", e["background-size"] = d.width +
        ...
        this.setText = function(a) {
            ...
            if (a)
                for (; 2 < Math.floor(w.scrollHeight /
                        c.defaultView.getComputedStyle(w, null).lineHeight.replace("px", ""));) w.innerHTML = w.innerHTML.replace(/(.*) .*$/, "$1...");
            b.height = "";
            b.display = "";
            s()
        };
        ...
        a("#" + h, N);
        l.isMobile() || (E.overSrc && (N["background-image"] = "url(" + u.overSrc + "), url(" + E.overSrc + "), url(" + p.overSrc + ")"), a(".jw-tab-focus #" + h +
...
(function(d) {
    ...
    l.instream = function(j, b, m, g) {
        ...
        D.init = function() {
            ...
            J = b.playlist[b.item];
            x = t.currentTime;
            g.checkBeforePlay() || 0 === x && !b.getVideo().checkComplete() ? (x = 0, M = e.PLAYING) : M = b.getVideo().checkComplete() ? e.IDLE : j.jwGetState() === e.IDLE ? e.IDLE : e.PLAYING;
            M === e.PLAYING && t.pause();
            P = new l.display(D);
...
(function(d) {
    var l = d.utils,
        ...
        f = d.html5.logo = function(e, h) {
            ...
            var v = "o";
            b.edition && (v = b.edition(), v = "pro" === v ? "p" : "premium" === v ? "r" : "ads" === v ? "a" : "free" === v ? "f" : "o");
            if ("o" === v || "f" === v) q.link = "http://www.longtailvideo.com/jwpabout/?a\x3dl\x26v\x3d" + d.version + "\x26m\x3dh\x26e\x3d" + v;
            g = l.extend({}, q, h);
...
(function(d) {
    ...
    l.menu = function(d, e, h, j) {
        ...
        this.addOption = function(b, c) {
            ...
            d.id = e + "_option_" + c;
            d.innerHTML = b;
            a.isMobile() ? (new a.touch(d)).addEventListener(a.touchEvents.TAP, m(C.length, c)) : d.addEventListener("click", m(C.length, c));
            C.push(d)
        };
        ...
        j.setItem =
            function(a) {
                ...
                if (b || a !== j.item) j.item = a, j.sendEvent(c.JWPLAYER_PLAYLIST_ITEM, {
                    index: j.item
                }), b = j.playlist[a], a = l.chooseProvider(b && b.sources && b.sources[0]), k instanceof a || (k = e || new a(j.id), j.setVideoProvider(k)), k.init && k.init(b)
            };
...
(function(d) {
    ...
    a.playlistcomponent = function(d, b) {
        ...
        w.itemImage ? (L = (z - w.itemImage.height) / 2 + "px ", G = w.itemImage.width, t = w.itemImage.height) : (G = 4 * z / 3, t = z);
            ...
            if (n = c) {
                ...
                for (b = 0; b < n.length; b++) {
                    var j = b,
                        ...
                        l = void 0;
                    d.id = y.id + "_item_" + j;
                    0 < j ? (l = g("div", "jwplaylistdivider"), d.appendChild(l)) : (j = w.divider ? w.divider.height : 0, d.style.height = z - j + "px", d.style["background-size"] = "100% " + (z - j) + "px");
                    j = g("div", "jwplaylistimg jwfill");
                    l = void 0;
                    c["playlist.image"] && w.itemImage ? l = c["playlist.image"] : c.image && w.itemImage ? l = c.image : w.itemImage && (l = w.itemImage.src);
...
(function(d) {
    ...
    d.playlistslider = function(d, b, l, g) {
        ...
        function v(a) {
            if (x) return a = a ? a : h.event, Z(L - (a.detail ? -1 * a.detail : a.wheelDelta / 40) / 10), a.stopPropagation && a.stopPropagation(), a.preventDefault ? a.preventDefault() : a.returnValue = !1, a.cancelBubble = !0, a.cancel = !0, !1
        }
...
(function(d) {
    ...
    d.skinloader = function(c, f, e) {
        ...
        var q = {},
            ...
            y = 1;
        "string" !== typeof r || "" === r ? b(d.defaultskin()) : "xml" !== l.extension(r) ? v("Skin not a valid file type") : new d.skinloader("", h, v)
    }
})(jwplayer.html5);
(function(d) {
    var l = d.utils,
    ...
    a.view = function(r, n) {
        ...
        function A() {
            ...
            if (document.body.contains(Q)) {
                if (c && e && (c !== Ka || e !== $a)) Ka = c, $a = e, V && V.redraw(), clearTimeout(Ba), Ba = setTimeout(W, 50), ja.sendEvent(f.JWPLAYER_RESIZE, {
                    width: c,
                    height: e
                })
        ...
        function Z(a) {
            void 0 !== a.jwstate ? a = a.jwstate : ya ? (a = document.fullscreenElement || document.webkitCurrentFullScreenElement || document.mozFullScreenElement || document.msFullscreenElement, a = !!(a && a.id === r.id)) : a = ua ? U.getVideo().getFullScreen() :
            ...
            if (n.getVideo().isCaster) V && (V.show(), V.hidePreview(!1)), h.style(ga, {
                ...
                switch (a) {
                    case e.PLAYING:
                        ...
                        (ua ? U : n).getVideo().isAudioFile() ? (Na(!1), V.hidePreview(R), V.setHiding(!0), O && (Ma(), O.hideFullscreen(!0)), ra()) : (Na(!0), W(), V.hidePreview(!0), O && O.hideFullscreen(!n.getVideo().supportsFullscreen()));
                        break;
                    case e.IDLE:
                        Na(!1);
        ...
        this.setup = function(j) {
            if (!aa) {
                ...
                n.playlistsize && (n.playlistposition && n.playlistposition !== v) && (Ia = new a.playlistcomponent(r, {}), Ra.appendChild(Ia.element()));
                ...
                r.jwAddEventListener(f.JWPLAYER_CAST_SESSION, function(a) {
                    ...
                    a.active ? (h.style(B.element(), {
                        display: "none"
                    }), ja.forceControls(!0), ba.setState("connecting").setName(a.deviceName).show(), r.jwAddEventListener(f.JWPLAYER_PLAYER_STATE, ba.statusDelegate), r.jwAddEventListener(f.JWPLAYER_CAST_AD_CHANGED, N)) : (r.jwRemoveEventListener(f.JWPLAYER_PLAYER_STATE,
                        ba.statusDelegate), r.jwRemoveEventListener(f.JWPLAYER_CAST_AD_CHANGED, N), ba.hide(), O.adMode() && P(), h.style(B.element(), {
                        display: null
                    }), Da({
                        newstate: r.jwGetState()
                    }), A())
                ...
                b || (la.addEventListener("mouseout", G, !1), la.addEventListener("mousemove", M, !1), c.isMSIE() && (ga.addEventListener("mousemove", M, !1), ga.addEventListener("click", V.clickHandler)));
                F(O);
                F(ca);
                F($);
                h("#" + Q.id + "." + k + " .jwaspect", {
        ...
        var ka = this.fullscreen = function(a) {
            ...
            a = !!a;
            a !== n.fullscreen && (ya ? (a ? Qa.apply(Q) : qa.apply(document), Y(Q, a)) : c.isIE() ? Y(Q, a) : (U && U.getVideo().setFullScreen(a), n.getVideo().setFullScreen(a)))
        };
        ...
        Q.id = r.id;
        Q.tabIndex = 0;
        Qa = Q.requestFullscreen || Q.webkitRequestFullscreen || Q.webkitRequestFullScreen || Q.mozRequestFullScreen || Q.msRequestFullscreen;
        qa = document.exitFullscreen || document.webkitExitFullscreen || document.webkitCancelFullScreen || document.mozCancelFullScreen || document.msExitFullscreen;
        ya = Qa && qa;
    ...
    j.castDisplay = function(q) {
        ...
        s || (k(".jwplayer .jwcast-display", {
            ...
            k(".jwplayer .jwcast-label", {
                ...
                opacity: 1
            }), h.cssKeyframes("spin", "from {transform: rotate(0deg);} to {transform: rotate(360deg);}"), k(".jwcast-connecting .jwcast-wheel, .jwcast-buffering .jwcast-wheel", {
                opacity: 1,
        ...
        this.setCompanions = function(a) {
            ...
            for (d = a.length; d--;)
                ...
                }(a = h) ? (null === H && (H = c("div", "companion"), e(u, H)), a.width / a.height > v ? (b = 316, d = a.height * b / a.width) : (d = 176,
        ...
        this.adChanged = function(a) {
            if (a.complete) J && J.reset(-1), M = null;
                ...
                J && (void 0 === a.skipoffset ? m() : (a.position || a.duration) && J.updateSkipTime(a.position | 0, a.duration | 0));
                var b = a.tag + a.sequence;
                b !== M && (k(t + " .jwpreview", {
                    opacity: 0
                }), a.companions ? this.setCompanions(a.companions) : y(), a.clickthrough ? null === K && (K = c("div", "click-label"), K.innerText = "Click here to learn more \x3e", e(u, K)) : n(), M = b, this.setState(a.newstate))
            }
        };
...
(function(d) {
    ...
    d.rightclick = function(c, f) {
        if ("free" == c.edition()) f.aboutlink = "http://www.longtailvideo.com/jwpabout/?a\x3dr\x26v\x3d" + d.version + "\x26m\x3dh\x26e\x3df", delete f.abouttext;
        else {
            if (!f.aboutlink) {
                var e = "http://www.longtailvideo.com/jwpabout/?a\x3dr\x26v\x3d" + d.version + "\x26m\x3dh\x26e\x3d",
                    h = c.edition();
