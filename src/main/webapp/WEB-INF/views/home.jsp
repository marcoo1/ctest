...
<div id="container">
    <div id="content">
		...
		<div id="noscroll" class="chart">
			<h1> Channel Season 1 </h1>
	        <iframe  height="400px" width="90%" src="videoslider?channel=s1"></iframe>
	    </div>
	    <div class="chart">    
			<div><h1> Channel Season 2</h1></div>
	        <iframe height="400" width="90%" src="videoslider2?channel=s2"></iframe>
		</div>
		<div class="chart">    
			<div><h1> Channel Season 3</h1></div>
	     <iframe height="400" width="90%" src="videoslider3?channel=s3"></iframe>
		</div>
	    <div class="chart">    
			<div><h1> Channel Season 4</h1></div>
	        <iframe height="400" width="90%" src="videoslider4?channel=s4"></iframe>
		</div>
		<div> &nbsp;</div><div> &nbsp;</div>
		<div>
    </div>
