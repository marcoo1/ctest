...
(function(f) {
    function n(b, c) {
        function d() {
            var g, b, e, c, d, f = !1;
            a.thumbInnerContainer.unbind("touchstart.ap touchmove.ap touchend.ap click.ap-touchclick").bind("touchstart.ap", function(k) {
                if (!a._componentInited) return !1;
                if (!a.touchOn) return !0;
                k = k.originalEvent.touches[0];
                g = a.thumbInnerContainer.position().left;
                b = a.thumbInnerContainer.position().top;
                e = k.pageX;
                c = k.pageY;
                d = !1;
                f = !0
            }).bind("touchmove.ap", function(k) {
                if (f) {
                    k = k.originalEvent.touches[0];
                    var h;
                    "horizontal" == a._thumbOrientation ? (h = g - e + k.pageX,
                        h > a._thumbBackwardSize ? h = a._thumbBackwardSize : h < a._getComponentSize("w") - a.thumbInnerContainerSize - a._thumbForwardSize && (h = a._getComponentSize("w") - a.thumbInnerContainerSize - a._thumbForwardSize), a.thumbInnerContainer.css("left", h + "px")) : (h = b - c + k.pageY, h > a._thumbBackwardSize ? h = a._thumbBackwardSize : h < a._getComponentSize("h") - a.thumbInnerContainerSize - a._thumbForwardSize && (h = a._getComponentSize("h") - a.thumbInnerContainerSize - a._thumbForwardSize), a.thumbInnerContainer.css("top", h + "px"));
                    d = d || 5 < Math.abs(e -
                        k.pageX) || 5 < Math.abs(c - k.pageY);
                    return !1
                }
        ...
        a.ic_thumb_forward = "../../static/img/icons/thumb_forward.png";
        a.ic_thumb_forward_on = "../../static/img/icons/thumb_forward_on.png";
        a.ic_thumb_backward = "../../static/img/icons/thumb_backward.png";
        a.ic_thumb_backward_on = "../../static/img/icons/thumb_backward_on.png";
        a.ic_thumb_forward_v = "../../static/img/icons/thumb_forward_v.png";
        a.ic_thumb_forward_v_on = "../../static/img/icons/thumb_forward_v_on.png";
        a.ic_thumb_backward_v = "../../static/img/icons/thumb_backward_v.png";
        a.ic_thumb_backward_v_on = "../../static/img/icons/thumb_backward_v_on.png";
        ...
        "scroll" != this._moveType && (this.isMobile || (this.thumbForward.bind("mouseover", function() {
            ...
            if (!a.thumbTransitionOn) {
                ...
                var g, b;
                "horizontal" == a._thumbOrientation ? (g = parseInt(a.thumbInnerContainer.css("left"), 10), g += a.thumbContainerWidth + a.verticalSpacing, 0 < g && (g = 0), b = Math.ceil(a.thumbContainerWidth / (a.boxWidth + a.verticalSpacing)), a.lastWheelCounter += b, a.thumbInnerContainer.stop().animate({
                    left: g + "px"
                }, {
                    duration: 700,
                    easing: "easeOutQuart",
                ...
                })) : (g = parseInt(a.thumbInnerContainer.css("top"), 10), g += a.thumbContainerHeight + a.horizontalSpacing, 0 < g && (g = 0), b = Math.ceil(a.thumbContainerHeight / (a.boxHeight + a.horizontalSpacing)), a.lastWheelCounter += b, a.thumbInnerContainer.stop().animate({
                    top: g + "px"
                }, {
                    duration: 700,
                    easing: "easeOutQuart",
            ...
            if (!a.thumbTransitionOn) {
                a.thumbTransitionOn = !0;
                var g, b;
                "horizontal" == a._thumbOrientation ? (g = parseInt(a.thumbInnerContainer.css("left"),
                    10), g -= a.thumbContainerWidth + a.verticalSpacing, g < -a.thumbInnerContainerSize + a.thumbContainerWidth && (g = -a.thumbInnerContainerSize + a.thumbContainerWidth), b = Math.ceil(a.thumbContainerWidth / (a.boxWidth + a.verticalSpacing)), a.lastWheelCounter -= b, a.thumbInnerContainer.stop().animate({
                    left: g + "px"
                }, {
                    duration: 700,
                    easing: "easeOutQuart",
                ...
                })) : (g = parseInt(a.thumbInnerContainer.css("top"), 10), g -= a.thumbContainerHeight + a.horizontalSpacing, g < -a.thumbInnerContainerSize + a.thumbContainerHeight &&
                    (g = -a.thumbInnerContainerSize + a.thumbContainerHeight), b = Math.ceil(a.thumbContainerHeight / (a.boxHeight + a.horizontalSpacing)), a.lastWheelCounter -= b, a.thumbInnerContainer.stop().animate({
                        top: g + "px"
                    }, {
                        duration: 700,
                        easing: "easeOutQuart",
        ...
        this.thumbInnerContainer.children("div[class=thumbHolder]").each(function() {
            ...
            a._thumbHolderArr.push(l);
            p || (a.boxWidth = a._thumbHolderArr[0].width(), a.boxHeight = a._thumbHolderArr[0].height(), p = !0);
            if (0 < l.find("div[class='innerThumbHolder']").length) {
                a.innerSlideshowExist = !0;
                var b = [],
                    c = 0;
                l.find("div[class='innerThumbHolder']").each(function() {
                    m =
                        f(this).attr({
                            "data-id-i": h,
                            "data-id-j": c
                    ...
                    b.push(m);
                    void 0 == m.attr("data-title") || a._isEmpty(m.attr("data-title")) || a.createTitle(m);
                    a.isMobile || m.bind("mouseenter", function(b) {
                        if (!a._componentInited) return !1;
                        b || (b = window.event);
                    ...
                    0 < m.find("a[class=pp_content]").length && m.find("a[class=pp_content]").bind("click", function() {
                ...
                a.slideShowData[h] = a.createSlideshow(l)
            } else void 0 == l.attr("data-title") || a._isEmpty(l.attr("data-title")) || a.createTitle(l), a.isMobile || l.bind("mouseenter", function(b) {
                if (!a._componentInited) return !1;
                b || (b = window.event);
                b.cancelBubble ?
            ...
            }), 0 < l.find("a[class=pp_content]").length && l.find("a[class=pp_content]").bind("click", function(a) {
                "undefined" !== typeof detailActivated && detailActivated()
            });
            h++
        });
        ...
        if ("line" ==
            ...
            h = 0;
            for (h; h < this._playlistLength; h++) this.thumbInnerContainerSize =
                "horizontal" == this._thumbOrientation ? this.thumbInnerContainerSize + this._thumbHolderArr[h].outerWidth(!0) : this.thumbInnerContainerSize + this._thumbHolderArr[h].outerHeight(!0);
            "horizontal" == this._thumbOrientation ? this.thumbInnerContainer.width(this.thumbInnerContainerSize + 400) : this.thumbInnerContainer.height(this.thumbInnerContainerSize)
        }
    ...
    n.prototype = {
        ...
        createGrid: function(b, c, d, a, f, l, m, p, g) {
            for (var n = [], e, q, r, t = b * c, k = 0; k < t; k++) e = {}, g ? (q = k % b, r = Math.floor(k / b), e.x = q * (d + f) + m, e.y = r * (a + l) + p) : (q = k % c, r = Math.floor(k / c), e.x = r * (d + f) + m, e.y = q * (a + l) + p), n.push(e);
            return n
        }
    };
    f.fn.thumbGallery = function(b) {
        return this.each(function() {
            var c = new n(f(this), b);
